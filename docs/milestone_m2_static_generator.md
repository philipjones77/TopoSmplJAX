...
4. Benchmarks:
   - `examples/benchmark_static_generation.py`
   - `examples/benchmark_jax_quality_pipeline.py`
5. Notebook:
...
4. M3 tests in `tests/test_m3_boundary_and_refine.py`.
5. Demo script in `examples/m3_boundary_refine_demo.py`.
