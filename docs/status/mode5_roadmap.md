...
- `src/gmshjax/mesh/fields.py`
- `src/gmshjax/mesh/metrics.py`
- `src/gmshjax/ad/controller.py`
...
- `src/gmshjax/transfer/point_fields.py`
- `src/gmshjax/transfer/element_fields.py`
- `src/gmshjax/transfer/state.py`
...
- `src/gmshjax/mesh/connectivity_opt.py`
...
- `src/gmshjax/ad/driver.py`
- `src/gmshjax/ad/modes.py`
- `src/gmshjax/ad/controller.py`
...
- `src/gmshjax/ad/dynamic.py`
- `examples/m5_dynamic_tri_prototype.py`
- `tests/test_mode5_dynamic_proto.py`
...
- `docs/objects/mesh_movement_modes.md`
- `docs/theory/mesh_movement_modes.md`
- `docs/implementation/mesh_movement_modes.md`
