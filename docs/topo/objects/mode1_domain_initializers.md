...
- `sphere_volume_tet_mesh`
  Build a tetrahedral sphere mesh by specializing the implicit-volume contract to a sphere signed-distance field.

- `sphere_volume_tet_mesh_tagged`
  Same sphere-volume initialization, with tagged boundary faces.
